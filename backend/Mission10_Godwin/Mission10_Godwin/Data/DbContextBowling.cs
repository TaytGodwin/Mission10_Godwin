...
namespace Mission10_Godwin.Data;

public partial class DbContextBowling : DbContext
{
    public DbContextBowling()
    {
    }

    public DbContextBowling(DbContextOptions<DbContextBowling> options)
        : base(options)
    {
    }
